...
# does hash table preserve order?
'''
hash_table = HashTable()

hash_table.storage = [Node('key3', 'v3'), None, None, Node('key1', 'val1')]
...
# also by default uses first item in each tuple to sort

dict_list.sort()  # or dict_list.sort(reverse=True)
